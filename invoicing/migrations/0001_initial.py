    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(blank=True, choices=[('Haut Katanga', 'Haut Katanga'), ('Lualaba', 'Lualaba'), ('Kinshasa', 'Kinshasa'), ('Autre', 'Autre')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentTerms', models.CharField(choices=[('14 jours', '14 jours'), ('30 jours', '30 jours'), ('60 jours', '60 jours')], default='14 jours', max_length=100)),
                ('status', models.CharField(choices=[('ACTUELLE', 'ACTUELLE'), ('EMAIL_ENVOYE', 'EMAIL_ENVOYE'), ('RETARD DE PYT', 'RETARD DE PYT'), ('PAYE', 'PAYE')], default='ACTUELLE', max_length=100)),
                ('notes', models.TextField(blank=True, null=True)),
                ('uniqueId', models.CharField(blank=True, max_length=100, null=True)),
                ('slug', models.SlugField(blank=True, max_length=500, null=True, unique=True)),
                ('date_created', models.DateTimeField(blank=True, null=True)),
                ('last_updated', models.DateTimeField(blank=True, null=True)),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='invoicing.client')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('currency', models.CharField(choices=[('Fc', 'CDF'), ('$', 'USD')], default='$', max_length=100)),
                ('uniqueId', models.CharField(blank=True, max_length=100, null=True)),
                ('slug', models.SlugField(blank=True, max_length=500, null=True, unique=True)),
                ('date_created', models.DateTimeField(blank=True, null=True)),
                ('last_updated', models.DateTimeField(blank=True, null=True)),
